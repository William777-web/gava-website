...
```
website/
├── index.html        # 单页官网·中文（Hero/总成本/承诺/品类/代表产品/应用/资料下载/为什么/服务支持/流程/常见问题/关于/联系）
├── en/index.html     # 英文版官网（/en/，语言切换 + hreflang，外贸客户）
...
## 本地预览
```bash
cd "/Users/william/Desktop/workspace for codex/projects/project_006_深圳市伽桦智能科技有限公司工业过滤"
